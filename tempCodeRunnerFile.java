...
public class Kiosk {
    public static void main(String[] args) {
        ...
        while (mesinnyala) {
            ...
            if (pilih == 4) {
                System.out.println("Thank You! sudah berkunjung ke situs Universitas Pertamina SoundFest 2026");
                mesinnyala = false;
                break;
            }
            ...
            if (jumlahbeli > stok) {
                System.out.println("Maaf, stok " + kategori + " tidak mencukupi: " + stok);
                continue;
            }
            ...
            for (int i = 1; i <= jumlahbeli; i++) {
                ...
                while (!inputumur) {
                    ...
                    if (umur < 1 || umur > 100) {
                        System.out.println("Umur tidak valid. Silakan masukkan umur yang benar (1-100).");
                        continue;
                    }
                ...
                if (pilih == 1 || pilih == 2) {
                    if (umur < batas) {
                        System.out.println("Maaf, anda tidak memenuhi syarat untuk membeli tiket " + kategori + " karena umur Anda kurang dari " + batas + " tahun.");
